...
import com.huaweicloud.cs.java_intl.v1.model.ClusterInfo;
...
public class QueryClusterResponse {
  ...
  private ClusterInfo payload = null;

  public QueryClusterResponse messageId(String messageId) {
  ...
  **/
  ...
  public QueryClusterResponse message(String message) {
  ...
  **/
  ...
  public QueryClusterResponse currentTime(Long currentTime) {
  ...
  **/
  ...
  public QueryClusterResponse payload(ClusterInfo payload) {
  ...
  **/
  ...
  public ClusterInfo getPayload() {
    return payload;
  }

  public void setPayload(ClusterInfo payload) {
    this.payload = payload;
  }
  ...
  public String toString() {
    ...
    sb.append("class QueryClusterResponse {\n");
